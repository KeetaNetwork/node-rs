...
impl_variant_error_from!(AccountError, {
	keetanetwork_asn1::error::Asn1Error => InvalidConstruction,
});
...
impl From<AccountError> for keetanetwork_crypto::operations::SignatureError {
...
mod tests {
	...
	test_error_from_conversions! {
		test_from_asn1_implementations, AccountError, [
			keetanetwork_asn1::error::Asn1Error::InvalidOid { reason: "test.oid".to_string() },
		]
	}
