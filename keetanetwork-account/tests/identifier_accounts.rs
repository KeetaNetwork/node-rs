...
use keetanetwork_account::{Account, AccountError, AccountPublicKey, GenericAccount, KeyPairType, KeyTOKEN};
...
fn verify_token_identifier_properties(account: &keetanetwork_account::Account<keetanetwork_account::KeyTOKEN>) {
...
fn verify_storage_identifier_properties(account: &keetanetwork_account::Account<keetanetwork_account::KeySTORAGE>) {
